import { bottomDescription, facebookLink, instagramLink, linkdingLink, twitterLink } from "@/types/global";
        ...
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12">
            <div className="mb-10 w-full">
              ...
              <p className="mb-8 max-w-[270px] text-base text-white-1">
                {bottomDescription}
              </p>
              <div className="-mx-3 flex items-center">
                <a
                  ...
                  className="px-3 text-white-1 hover:text-white"
                >
                  <svg
                    width="22"
                    height="22"
            ...
            <div className="mb-10 w-full">
              ...
              <ul>
                <li>
                  <a
                    href="/#"
                    className="mb-3 inline-block text-base text-white-1 hover:text-primary"
                  >
                    Home
                  </a>
                </li>
          ...
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-3/12 xl:w-2/12">
            <div className="mb-10 w-full">
              ...
              <ul>
                <li>
                  <a
                    href="https://webcricrush.web.app/"
                    target="_blank"
