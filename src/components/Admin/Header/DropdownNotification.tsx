      ...
      <li>
        ...
        {dropdownOpen && (
          ...
          >
            ...
            <Link
              className="flex items-center justify-center rounded-[7px] border border-primary p-2.5 font-medium text-primary hover:bg-orange-light-5 dark:border-dark-4 dark:text-dark-6 dark:hover:border-primary dark:hover:bg-orange-light-3 dark:hover:text-primary"
              href="#"
            >
