...
import ConsultationModal from "../Hero/ConsultationModal";
      ...
      >
        <div className="container">
          <div className="relative -mx-4 flex items-center justify-between">
            <div className="w-20 max-w-full px-0">
              <Link
                href="/"
            ...
            <div className="flex w-full items-center justify-between px-4">
              ...
              <div className="hidden items-center justify-end pr-16 sm:flex lg:pr-0">
                ...
                <Link
                  ...
                  className={`relative px-7 py-3 text-base font-medium hover:opacity-70 overflow-hidden rounded-full ${sticky ? "text-dark dark:text-white" : "text-white"
                    } shine-button`}
                >
                  Get in touch
